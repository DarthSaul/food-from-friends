...
const EditProfile = () => {
	...
	return (
		<>
			{tab === 'profile' && (
				<div className="dashboard-form">
					...
					<div className="text-muted fw-light">
						Make changes to your public profile. Once finished,
					...
					<form className="form" onSubmit={handleSubmit}>
						...
						<div className="form-group">
							<div>
								...
								<small className="form-text">
									Please use comma separated values (eg. Cacio
									e Pepe, Tacos, Fried Rice, Ramen)
								</small>
							</div>
							<input
								type="text"
			...
			{tab === 'upload' && <FileUpload setTab={setTab} />}
		</>
	);
};
